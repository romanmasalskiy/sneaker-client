        ...
        <tbody>
            <tr>
                ...
                <td key={index}> {resellPrices?.stockX&&resellPrices?.stockX[size] ? <a
                    className={resellPrices?.stockX&&isMinPrice(resellPrices?.stockX[size], size)}
            ...
            <tr>
                ...
                <td key={index}> {resellPrices?.stadiumGoods &&resellPrices?.stadiumGoods[size] ? <a
                    className={resellPrices?.stadiumGoods&&isMinPrice(resellPrices?.stadiumGoods[size],
